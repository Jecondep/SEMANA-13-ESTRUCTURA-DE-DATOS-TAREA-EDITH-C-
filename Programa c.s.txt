class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        arbolRevistas.Insertar("Revista Ecología");
        arbolRevistas.Insertar("Tecnología Hoy");
        arbolRevistas.Insertar("Ciencia Amazónica");
        arbolRevistas.Insertar("Innovación Digital");
        arbolRevistas.Insertar("Explorador Natural");
        arbolRevistas.Insertar("Mundo Programador");
        arbolRevistas.Insertar("Visión Científica");
        arbolRevistas.Insertar("Futuro Tecnológico");
        arbolRevistas.Insertar("Naturaleza Viva");
        arbolRevistas.Insertar("Informática Avanzada");
